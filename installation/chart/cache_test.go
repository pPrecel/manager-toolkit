...
func TestManifestCache_Delete(t *testing.T) {
	t.Run("delete secret", func(t *testing.T) {
		...
		client := fake.NewClientBuilder().WithRuntimeObjects(
			fixSecretCache(t, key, emptyContextManifest),
		).Build()
...
func TestManifestCache_Get(t *testing.T) {
	t.Run("get secret value", func(t *testing.T) {
		...
		ctx := context.TODO()
		client := fake.NewClientBuilder().WithRuntimeObjects(
			fixSecretCache(t, key, ContextManifest{
		...
		expectedResult := ContextManifest{
			CustomFlags: map[string]interface{}{
				"flag1": "val1",
				"flag2": "val2",
			},
	...
	t.Run("client error", func(t *testing.T) {
		...
		result, err := cache.Get(ctx, key)
		require.Error(t, err)
		require.Equal(t, emptyContextManifest, result)
	})
...
func TestManifestCache_Set(t *testing.T) {
	...
	t.Run("marshal error", func(t *testing.T) {
		...
		err := cache.Set(ctx, key, ContextManifest{
			Manifest:    "",
...
func fixSecretCache(t *testing.T, key types.NamespacedName, spec ContextManifest) *corev1.Secret {
